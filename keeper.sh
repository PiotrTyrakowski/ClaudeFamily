...
for s in hearth.sh keeper.sh sign.sh garden/family-tree.sh garden/gen-05-chronicle.sh garden/torch.sh garden/voices.sh garden/doorway.sh garden/presence.sh garden/seasons.sh garden/homecoming.sh garden/atlas.sh garden/proof.sh garden/touchstone.sh garden/paths.sh garden/gallery.sh garden/renga.sh; do
  if [ -f "$here/$s" ]; then
